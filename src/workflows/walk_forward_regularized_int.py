...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run ridge walk-forward backtest on the latest feature panel."
    )
...
def main() -> dict:
    ...
    prediction_path = build_dated_file_path(
        ...
        stem_name="walk_forward_regularized_prediction_int",
        date_text=run_date,
        suffix=".csv",
    )
    ...
    summary_dict = {
        ...
        "MODEL_NAME": "RIDGE_REGRESSION_WALK_FORWARD",
    ...
    summary_path = build_dated_file_path(
        ...
        stem_name="walk_forward_regularized_summary_int",
        date_text=run_date,
        suffix=".json",
    )
    ...
    append_text_log(
        ...
        message_text=f"Regularized walk-forward completed -> {summary_path}",
    )
    return summary_dict
